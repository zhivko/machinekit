...
/* Autogenerated by /home/machinekit/git/machinekit/bin/instcomp on Mon Oct 24 07:33:23 2016 -- do not edit */
...
#ifdef MODULE_INFO
MODULE_INFO(machinekit, "component:udp:UDP Server for esp8266 udp client, that connects via serial (rs232 57600baud) to laser distance sensor (ODSL 9/D26-450-S12 - Optical distance sensor)");
MODULE_INFO(machinekit, "pin:distance:float:None:out::None");
MODULE_INFO(machinekit, "pin:touchOff:bit:None:out::None");
MODULE_INFO(machinekit, "funct:_:1:");
MODULE_INFO(machinekit, "author:Klemen Živkovič");
...
static int export_halobjs(struct inst_data *ip, int owner_id, const char *name)
{
    ...
    r = hal_pin_bit_newf(HAL_OUT, &(ip->touchOff), owner_id,
            "%s.touchOff", name);
    if(r != 0) return r;
...
#undef touchOff
#define touchOff (*ip->touchOff)
#undef localpincount
#define localpincount (ip->localpincount)


#line 23 "./git/machinekit/mycomponents/udp.icomp"
